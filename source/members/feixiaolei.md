...
<div class="profile-page">
  ...
  <div class="profile-card">
    <img class="profile-avatar" src="/island-blog/images/会飞的小雷.jpg" alt="会飞的小雷" onerror="this.src='https://api.dicebear.com/7.x/initials/svg?backgroundColor=fa709a&seed=会飞的小雷'">
    <div class="profile-info">
      <h1 class="profile-name">会飞的小雷</h1>
      <p class="profile-sign">少妇杀手喜欢开坦克</p>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-bio">
      <div class="bio-item"><span class="bio-label">昵称</span><span class="bio-value">会飞的小雷</span></div>
      <div class="bio-item"><span class="bio-label">职业</span><span class="bio-value">幽默达人</span></div>
      <div class="bio-item"><span class="bio-label">爱好</span><span class="bio-value">开车、段子、游戏</span></div>
      <div class="bio-item"><span class="bio-label">座右铭</span><span class="bio-value">人生就像开坦克，横冲直撞才过瘾</span></div>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-tags">
      <span class="tag">✨ 开车</span><span class="tag">✨ 段子</span><span class="tag">✨ 游戏</span>
    </div>
  </div>
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <div class="timeline-images single">
            <img src="https://picsum.photos/400/300?random=356" alt="">
          </div>
          <div class="timeline-meta">
            <span>❤️ 17</span>
            <span>💬 1</span>
  ...
  <div class="profile-section">
    ...
    <div class="photo-grid-9">
      <img src="https://picsum.photos/200/200?random=406" alt="" loading="lazy">
      <img src="https://picsum.photos/200/200?random=407" alt="" loading="lazy">
