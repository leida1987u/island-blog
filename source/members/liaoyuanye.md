...
<div class="profile-page">
  ...
  <div class="profile-cover" style="background: linear-gradient(135deg, #667eea 0%, #667eea88 100%);"></div>

  <div class="profile-card">
    <img class="profile-avatar" src="/island-blog/images/燎原一叶.jpg" alt="燎原一叶" onerror="this.src='https://api.dicebear.com/7.x/initials/svg?backgroundColor=667eea&seed=燎原一叶'">
    <div class="profile-info">
      <h1 class="profile-name">燎原一叶</h1>
      <p class="profile-sign">天生我才必有用，千金散尽还复来。</p>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-bio">
      <div class="bio-item"><span class="bio-label">昵称</span><span class="bio-value">燎原一叶</span></div>
      <div class="bio-item"><span class="bio-label">职业</span><span class="bio-value">技术爱好者</span></div>
      <div class="bio-item"><span class="bio-label">爱好</span><span class="bio-value">技术、折腾、AI</span></div>
      <div class="bio-item"><span class="bio-label">座右铭</span><span class="bio-value">天生我才必有用，千金散尽还复来。</span></div>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-tags">
      <span class="tag">✨ 技术</span><span class="tag">✨ 折腾</span><span class="tag">✨ AI</span>
    </div>
  </div>
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <div class="timeline-images single">
            <img src="https://picsum.photos/400/300?random=384" alt="">
          </div>
          <div class="timeline-meta">
            <span>❤️ 9</span>
            <span>💬 5</span>
