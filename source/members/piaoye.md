...
<div class="profile-page">
  ...
  <div class="profile-cover" style="background: linear-gradient(135deg, #ff6b6b 0%, #ff6b6b88 100%);"></div>

  <div class="profile-card">
    <img class="profile-avatar" src="/island-blog/images/痞爷.jpg" alt="痞爷" onerror="this.src='https://api.dicebear.com/7.x/initials/svg?backgroundColor=ff6b6b&seed=痞爷'">
    <div class="profile-info">
      <h1 class="profile-name">痞爷</h1>
      <p class="profile-sign">盼哥</p>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-bio">
      <div class="bio-item"><span class="bio-label">昵称</span><span class="bio-value">痞爷</span></div>
      <div class="bio-item"><span class="bio-label">职业</span><span class="bio-value">社交达人</span></div>
      <div class="bio-item"><span class="bio-label">爱好</span><span class="bio-value">聚会、交友、喝酒</span></div>
      <div class="bio-item"><span class="bio-label">座右铭</span><span class="bio-value">江湖人称盼哥</span></div>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-tags">
      <span class="tag">✨ 聚会</span><span class="tag">✨ 交友</span><span class="tag">✨ 喝酒</span>
    </div>
  </div>
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <div class="timeline-images single">
            <img src="https://picsum.photos/400/300?random=336" alt="">
          </div>
          <div class="timeline-meta">
            <span>❤️ 4</span>
            <span>💬 5</span>
