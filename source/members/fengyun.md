...
<div class="profile-page">
  ...
  <div class="profile-card">
    <img class="profile-avatar" src="/island-blog/images/FENGYUN.jpg" alt="FENGYUN" onerror="this.src='https://api.dicebear.com/7.x/initials/svg?backgroundColor=c2e9fb&seed=FENGYUN'">
    <div class="profile-info">
      <h1 class="profile-name">FENGYUN</h1>
      <p class="profile-sign">年轻有为</p>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-bio">
      <div class="bio-item"><span class="bio-label">昵称</span><span class="bio-value">FENGYUN</span></div>
      <div class="bio-item"><span class="bio-label">职业</span><span class="bio-value">创业者</span></div>
      <div class="bio-item"><span class="bio-label">爱好</span><span class="bio-value">创业、健身、读书</span></div>
      <div class="bio-item"><span class="bio-label">座右铭</span><span class="bio-value">年轻有为，未来可期</span></div>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-tags">
      <span class="tag">✨ 创业</span><span class="tag">✨ 健身</span><span class="tag">✨ 读书</span>
    </div>
  </div>
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <div class="timeline-images single">
            <img src="https://picsum.photos/400/300?random=334" alt="">
          </div>
          <div class="timeline-meta">
            <span>❤️ 17</span>
            <span>💬 3</span>
