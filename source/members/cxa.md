...
<div class="profile-page">
  ...
  <div class="profile-cover" style="background: linear-gradient(135deg, #96e6a1 0%, #96e6a188 100%);"></div>

  <div class="profile-card">
    <img class="profile-avatar" src="/island-blog/images/cxa.jpg" alt="cxa" onerror="this.src='https://api.dicebear.com/7.x/initials/svg?backgroundColor=96e6a1&seed=cxa'">
    <div class="profile-info">
      <h1 class="profile-name">cxa</h1>
      <p class="profile-sign">哈哈哈四眼仔</p>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-bio">
      <div class="bio-item"><span class="bio-label">昵称</span><span class="bio-value">cxa</span></div>
      <div class="bio-item"><span class="bio-label">职业</span><span class="bio-value">学霸</span></div>
      <div class="bio-item"><span class="bio-label">爱好</span><span class="bio-value">阅读、思考、编程</span></div>
      <div class="bio-item"><span class="bio-label">座右铭</span><span class="bio-value">眼镜是心灵的窗户框</span></div>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-tags">
      <span class="tag">✨ 阅读</span><span class="tag">✨ 思考</span><span class="tag">✨ 编程</span>
    </div>
  </div>
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <div class="timeline-images single">
            <img src="https://picsum.photos/400/300?random=373" alt="">
          </div>
          <div class="timeline-meta">
            <span>❤️ 10</span>
            <span>💬 8</span>
  ...
  <div class="profile-section">
    ...
    <div class="photo-grid-9">
      ...
      <img src="https://picsum.photos/200/200?random=431" alt="" loading="lazy">
    </div>
  </div>
