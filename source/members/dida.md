...
<div class="profile-page">
  ...
  <div class="profile-cover" style="background: linear-gradient(135deg, #43e97b 0%, #43e97b88 100%);"></div>

  <div class="profile-card">
    <img class="profile-avatar" src="/island-blog/images/滴答.jpg" alt="滴答" onerror="this.src='https://api.dicebear.com/7.x/initials/svg?backgroundColor=43e97b&seed=滴答'">
    <div class="profile-info">
      <h1 class="profile-name">滴答</h1>
      <p class="profile-sign">钓鱼佬</p>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-bio">
      <div class="bio-item"><span class="bio-label">昵称</span><span class="bio-value">滴答</span></div>
      <div class="bio-item"><span class="bio-label">职业</span><span class="bio-value">垂钓达人</span></div>
      <div class="bio-item"><span class="bio-label">爱好</span><span class="bio-value">钓鱼、户外、野炊</span></div>
      <div class="bio-item"><span class="bio-label">座右铭</span><span class="bio-value">钓鱼钓的不是鱼，是心情</span></div>
    </div>
  </div>
  ...
  <div class="profile-section">
    ...
    <div class="profile-tags">
      <span class="tag">✨ 钓鱼</span><span class="tag">✨ 户外</span><span class="tag">✨ 野炊</span>
    </div>
  </div>
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <div class="timeline-images single">
            <img src="https://picsum.photos/400/300?random=376" alt="">
          </div>
          <div class="timeline-meta">
            <span>❤️ 17</span>
            <span>💬 1</span>
  ...
  <div class="profile-section">
    ...
    <div class="photo-grid-9">
      ...
      <img src="https://picsum.photos/200/200?random=432" alt="" loading="lazy">
      <img src="https://picsum.photos/200/200?random=433" alt="" loading="lazy">
      <img src="https://picsum.photos/200/200?random=434" alt="" loading="lazy">
    </div>
  </div>
